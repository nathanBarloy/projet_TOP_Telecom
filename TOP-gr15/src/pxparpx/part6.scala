...
def sommeHisto(h1:Array[Int],h2:Array[Int]):Array[Array[Int]]={
...
def soustrHisto(h1:Array[Int],h2:Array[Int]):Array[Array[Int]]={
...
def extractHistoIntegral(hist_int: Array[Array[Array[Int]]], i:Int, j:Int, motif: Array[Array[Int]]){
